...
import com.br.xbizitwork.data.repository.profile.ProfileRepositoryImpl
...
object ProfileModule {
    ...
    fun provideUpdateProfileUseCase(
        ...
        return UpdateProfileUseCaseImpl(repository, coroutineDispatcherProvider)
    }
