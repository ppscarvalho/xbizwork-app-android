...
import com.br.xbizitwork.data.mappers.toChangePasswordResult
...
class UserAuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun changePassword(changePasswordModel: ChangePasswordModel): DefaultResult<ChangePasswordResult> =
        withContext(coroutineDispatcherProvider.io()) {
            ...
            when (result) {
                is DefaultResult.Success -> {
                    val domainResponse = result.data.toChangePasswordResult()
                    DefaultResult.Success(domainResponse)
                }
